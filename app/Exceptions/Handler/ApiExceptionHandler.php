...
class ApiExceptionHandler
{
    ...
    public static function handle(Throwable $e): JsonResponse
    {
        ...
        return match (true) {
            ...
            $e instanceof GeneralJsonException           => self::handleGeneral($e, $errorId),
    ...
    private static function handleGeneral(GeneralJsonException $e, string $errorId): JsonResponse
    {
        return (new self)->error(
            message: $e->getMessage(),
            code: $e->getErrorCode(),
